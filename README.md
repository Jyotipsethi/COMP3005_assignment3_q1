...
DBMS:
DBMS commands are mentioned in the 'DBMS commands' text file. These can be copied and pasted in pgadmin4 query tool to execute for initial creation and population of the database.

Video Demonstration link - https://youtu.be/aTRcidauBLs
